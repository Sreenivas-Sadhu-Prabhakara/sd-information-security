package com.bank.bian.informationsecurity.model;
...
/**
 * The BIAN control record for this service domain: "Security Policy Administrative Plan".
 *
 ...
 * to its asset type (Security Policy). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Security Policy Administrative Plan";
